...
$routes->group('api', ['namespace' => 'App\Controllers\Api'], static function ($routes) {
    ...
    // API Películas
    $routes->get('peliculas', 'Peliculas::index');
    $routes->get('peliculas/activas', 'Peliculas::activas');
    $routes->get('peliculas/(:num)', 'Peliculas::show/$1');
    $routes->post('peliculas', 'Peliculas::create');
    $routes->put('peliculas/(:num)', 'Peliculas::update/$1');
    $routes->delete('peliculas/(:num)', 'Peliculas::delete/$1');
    $routes->put('peliculas/activar/(:num)', 'Peliculas::activar/$1');
    $routes->put('peliculas/inactivar/(:num)', 'Peliculas::inactivar/$1');

    // API Clientes
    $routes->get('clientes', 'Clientes::index');
    $routes->post('clientes', 'Clientes::create');
    $routes->delete('clientes/(:num)', 'Clientes::delete/$1');
    $routes->put('clientes/activar/(:num)', 'Clientes::activar/$1');
    $routes->put('clientes/inactivar/(:num)', 'Clientes::inactivar/$1');
